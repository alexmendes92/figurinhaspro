...
export const mockSellers: MockSeller[] = [
  {
    id: "rv-001",
    name: "João Silva",
    email: "joao@figurinhas.com",
    phone: "(11) 99988-7766",
    shopName: "Figurinhas do João",
    shopSlug: "joao",
    status: "ACTIVE",
    plan: "PRO",
    albumCount: 5,
    clientCount: 128,
    totalTransacted: 15400,
    createdAt: "2025-03-15",
  },
  {
    id: "rv-002",
    name: "Maria Santos",
    email: "maria@colecoes.com",
    phone: "(21) 98877-6655",
    shopName: "Coleções da Maria",
    shopSlug: "maria",
    status: "ACTIVE",
    plan: "UNLIMITED",
    albumCount: 12,
    clientCount: 342,
    totalTransacted: 48900,
    createdAt: "2025-01-20",
  },
  {
    id: "rv-003",
    name: "Carlos Oliveira",
    email: "carlos@stickers.com",
    phone: "(31) 97766-5544",
    shopName: "Stickers BR",
    shopSlug: "stickers-br",
    status: "ACTIVE",
    plan: "FREE",
    albumCount: 2,
    clientCount: 34,
    totalTransacted: 2100,
    createdAt: "2025-06-10",
  },
  {
    id: "rv-004",
    name: "Ana Paula Ferreira",
    email: "ana@albummania.com",
    phone: "(41) 96655-4433",
    shopName: "Album Mania",
    shopSlug: "album-mania",
    status: "ACTIVE",
    plan: "PRO",
    albumCount: 7,
    clientCount: 215,
    totalTransacted: 22800,
    createdAt: "2025-02-28",
  },
  {
    id: "rv-005",
    name: "Ricardo Mendes",
    email: "ricardo@colefig.com",
    phone: "(51) 95544-3322",
    shopName: "ColeFig",
    shopSlug: "colefig",
    status: "ACTIVE",
    ...
    albumCount: 4,
    clientCount: 89,
    totalTransacted: 9600,
    createdAt: "2025-04-05",
  },
  {
    id: "rv-006",
    name: "Fernanda Costa",
    email: "fernanda@fig.com",
    phone: "(61) 94433-2211",
    shopName: "Fernanda Figurinhas",
    shopSlug: "fernanda",
    status: "INACTIVE",
    plan: "FREE",
    albumCount: 1,
  ...
  },
  {
    ...
    albumCount: 15,
    clientCount: 567,
    totalTransacted: 72300,
    createdAt: "2024-11-10",
  },
  {
    id: "rv-008",
    name: "Juliana Souza",
    email: "juliana@souzafig.com",
    phone: "(81) 92211-0099",
    shopName: "Souza Figurinhas",
    shopSlug: "souza-fig",
    status: "ACTIVE",
    plan: "PRO",
    albumCount: 6,
    clientCount: 178,
    totalTransacted: 18200,
    createdAt: "2025-05-14",
  },
  {
    id: "rv-009",
    name: "Marcos Lima",
    email: "marcos@limacard.com",
    phone: "(85) 91100-9988",
    shopName: "Lima Cards",
    shopSlug: "lima-cards",
    status: "ACTIVE",
    ...
    albumCount: 3,
    clientCount: 45,
    totalTransacted: 3400,
    createdAt: "2025-08-01",
  },
  {
    id: "rv-010",
    name: "Patrícia Rocha",
    email: "patricia@rochafig.com",
    phone: "(91) 90099-8877",
    shopName: "Rocha Figurinhas",
    shopSlug: "rocha-fig",
    status: "INACTIVE",
    plan: "PRO",
    albumCount: 4,
    clientCount: 156,
    totalTransacted: 14700,
    createdAt: "2025-03-01",
  },
  {
    id: "rv-011",
    name: "Gabriel Santos",
    email: "gabriel@gsantos.com",
    phone: "(47) 99988-7700",
    shopName: "G Santos",
    shopSlug: "gsantos",
    status: "ACTIVE",
  ...
  },
  {
    id: "rv-012",
    name: "Camila Nunes",
    email: "camila@nunescards.com",
    phone: "(27) 98877-6600",
    shopName: "Nunes Cards",
    shopSlug: "nunes-cards",
    status: "ACTIVE",
    plan: "UNLIMITED",
    albumCount: 9,
    clientCount: 289,
    totalTransacted: 38500,
...
export function getResellerAlbums(sellerId: string): MockAlbum[] {
  ...
  if (!seller) return [];
  const seed = Number.parseInt(sellerId.replace("rv-", ""), 10) || 1;
  const count = Math.min(seller.albumCount, 8);

  return Array.from({ length: count }, (_, i) => ({
    id: `alb-${seed}-${i + 1}`,
    name: ALBUM_NAMES[(seed + i) % ALBUM_NAMES.length],
    status: (i === count - 1 && count > 1
      ? "DRAFT"
      : i > count - 2
        ? "ARCHIVED"
        : "ACTIVE") as MockAlbum["status"],
...
const TX_DESCRIPTIONS = [
  ...
  "Assinatura mensal Unlimited",
  "Venda figurinha avulsa",
  "Pedido #1042",
  "Pedido #1089",
  "Pedido #1123",
  "Reembolso parcial",
  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      status: (isRefund
        ...
        : i === count - 2
          ? "PENDING"
          : "PAID") as MockTransaction["status"],
      description: isRefund
        ? "Reembolso parcial"
        : TX_DESCRIPTIONS[(seed + i) % TX_DESCRIPTIONS.length],
    };
  });
}
...
export function getKpis() {
  ...
  const unlimitedCount = mockSellers.filter(
    (s) => s.plan === "UNLIMITED" && s.status === "ACTIVE"
  ).length;
