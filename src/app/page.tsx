...
const painPairs = [
  {
    pain: "Planilha com 670 linhas que você mesmo digitou",
    fix: "Scanner por câmera marca tudo em segundos, sem digitar uma linha",
  },
  {
    pain: "Preço errado = prejuízo certo no final do mês",
    fix: "Sugestão inteligente por raridade, demanda e seu histórico real",
  },
  {
    pain: '"Tem a do Vini Jr.?" 47 vezes no mesmo dia',
    fix: "Vitrine pública com link curto, QR e filtro por falta do cliente",
  },
  {
    pain: "Reserva no WhatsApp que nunca paga e some do grupo",
    fix: "Expiração automática em 30min + confirmação por Pix ou cartão",
  },
  {
    pain: "Cadê o lucro real? Só vejo entradas e saídas soltas",
    fix: "Financeiro com top vendedoras, giro por álbum e margem mensal",
  },
  {
    pain: "Lançou álbum novo — e agora reimportar tudo de novo?",
    fix: "Catálogo das 13 Copas já pronto. Copa 2026 chega automaticamente",
  },
];
...
const features = [
  {
    title: "Modo rápido",
    desc: "Bata 100 figurinhas em 40s com teclado numérico ou câmera. As mãos acompanham o cérebro.",
  },
  {
    title: "Preço que se mexe",
    desc: "Raridade × demanda × seu histórico. Toda noite, uma sugestão. Você aceita ou ignora.",
  },
  {
    title: "Vitrine que converte",
    desc: "Link curto, QR, tema custom. Comprador filtra por falta, reserva e paga sem você digitar nada.",
  },
  {
    title: "Alertas que importam",
    desc: '"Figurinha X é sua top 3 e acabou." Não é notificação — é gerência da sua revenda.',
  },
];
...
const steps = [
  {
    ...
    desc: "Cadastro em 30 segundos. Escolha o nome da sua loja e pronto.",
  },
  {
    num: "02",
    title: "Monte seu estoque",
    desc: "Selecione os álbuns, marque as figurinhas disponíveis e defina seus preços.",
  },
  {
    num: "03",
    title: "Compartilhe a vitrine",
    desc: "Envie o link da sua loja. Clientes montam o pedido e você recebe no WhatsApp.",
  },
];
...
const testimonials = [
  {
    name: "Rafael M.",
    city: "São Paulo, SP",
    text: "Vendia figurinhas pelo Excel. Com o FigurinhasPro, meu controle ficou 10x mais rápido e profissional.",
    stickers: "800+",
  },
  {
    name: "Camila S.",
    city: "Curitiba, PR",
    text: "Meus clientes adoram a vitrine. Montam o pedido sozinhos e eu só confirmo. Economizo horas por semana.",
    stickers: "1.200+",
  },
  {
    name: "Diego L.",
    city: "Belo Horizonte, MG",
    text: "Comecei no plano grátis e em 2 semanas fiz upgrade pro Pro. O investimento se paga no primeiro dia.",
    stickers: "500+",
  },
];
...
const faqs = [
  {
    ...
    a: "Não. O plano Starter é 100% grátis com 100 figurinhas, 10 pedidos/mês e 1 álbum. Faça upgrade quando quiser.",
  },
  {
    q: "Como meus clientes fazem pedidos?",
    a: "Você compartilha o link da sua vitrine. Eles escolhem as figurinhas, montam o carrinho e enviam o orçamento direto pelo WhatsApp.",
  },
  {
    q: "Posso cancelar a qualquer momento?",
    a: "Sim, sem multa e sem burocracia. O acesso continua até o fim do período pago.",
  },
  {
    q: "A Copa 2026 vai estar disponível?",
    a: "Sim. O álbum da Copa 2026 será adicionado assim que a Panini lançar oficialmente — seu estoque já estará pronto para receber.",
  },
  {
    q: "Quais formas de pagamento aceita?",
    a: "Cartão de crédito (Visa, Mastercard, Elo) e PIX, processados via Stripe com total segurança.",
  },
];
...
function StickerMini({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1.5 left-2 font-[family-name:var(--font-geist-mono)] text-[9px] font-bold text-white bg-black/40 backdrop-blur px-1.5 py-0.5 rounded">
        {num}
      </div>
      <div className="absolute top-1.5 right-2 font-[family-name:var(--font-geist-mono)] text-[8px] font-bold text-white/90 tracking-wider">
        {team}
      </div>
      ...
      {qty !== undefined && qty > 0 && (
        <div className="absolute bottom-1 right-1 min-w-[18px] h-[18px] px-1 rounded bg-black border border-white/20 font-[family-name:var(--font-geist-mono)] text-[9px] font-bold text-white flex items-center justify-center">
          ×{qty}
        </div>
      )}
      {qty === 0 && (
        <div className="absolute inset-0 bg-black/50 border-2 border-dashed border-white/20 rounded-xl" />
      )}
    </div>
  );
}
    ...
    <div className="min-h-screen bg-[#0b0e14]">
      ...
      <header className="sticky top-0 z-50 bg-[#0b0e14]/85 backdrop-blur-xl border-b border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-4">
          ...
          <nav className="hidden md:flex items-center gap-1">
            <Link
              href="#funciona"
              className="px-3 py-2 text-[13px] text-gray-400 hover:text-white transition-colors font-medium"
            >
              Como funciona
            </Link>
            <Link
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <Link
              href="/login"
              className="px-3 sm:px-4 py-2 text-[13px] text-gray-300 hover:text-white transition-colors font-medium"
            >
              Entrar
            </Link>
            <Link
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 pt-16 sm:pt-24 pb-12 sm:pb-20 grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-16 items-center">
          <div className="slide-up">
            ...
            <p className="text-[15px] sm:text-base lg:text-lg text-gray-400 leading-relaxed max-w-xl mb-8">
              FigurinhasPro transforma o caos do WhatsApp em operação profissional. Scanner por
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              ...
              <Link
                href="#funciona"
                className="px-6 sm:px-7 py-3.5 rounded-xl border border-white/10 text-gray-200 font-semibold text-sm hover:bg-white/[0.04] hover:border-white/20 transition-all text-center"
              >
            ...
            <div className="absolute top-10 right-0 w-[420px] z-10 rounded-2xl bg-[#0f1219] border border-white/[0.08] shadow-2xl shadow-black/60 p-5 slide-up">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  <span className="inline-block px-2.5 py-1 rounded-lg bg-emerald-500/10 text-emerald-400 text-[10px] font-bold border border-emerald-500/20">
                    +32% vs ontem
                  </span>
            ...
            <div className="ticker-track font-[family-name:var(--font-geist-mono)] text-[12px] text-gray-400">
              {[0, 1].map((k) => (
                ...
                >
                  ...
                  <span>
                    <b className="text-emerald-400 font-bold">1.204</b> figurinhas escaneadas hoje
                  </span>
                  <span className="text-gray-600">·</span>
                  <span>
                    <b className="text-emerald-400 font-bold">87</b> novas lojas esta semana
                  </span>
                  <span className="text-gray-600">·</span>
                  <span>
                    Brasil #10 subiu <b className="text-emerald-400 font-bold">+34%</b> em demanda
                  </span>
                  <span className="text-gray-600">·</span>
                  <span>
                    <b className="text-emerald-400 font-bold">492</b> pedidos fechados hoje
                  </span>
                </div>
              ))}
            </div>
            ...
            <div className="rounded-2xl bg-[#0f1219] border border-white/[0.08] shadow-2xl shadow-black/50 p-5">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex gap-1.5">
                  <span className="px-2 py-1 rounded-lg bg-white/5 text-gray-400 text-[11px] border border-white/[0.06]">
                    Ordenar: nº
                  </span>
                  <span className="px-2 py-1 rounded-lg bg-emerald-500/10 text-emerald-400 text-[11px] border border-emerald-500/20">
                    Scanner
                  </span>
                </div>
              </div>
                  ...
                  const bg =
                    rarity === "holo"
                      ...
                      : rarity === "legend"
                        ...
                        : "linear-gradient(160deg, #1a1f2e, #0b0e14)";
                  const qty = [
                    2, 0, 1, 4, 1, 0, 3, 2, 1, 1, 0, 5, 2, 1, 0, 3, 1, 0, 2, 1, 0, 2, 3, 1,
                  ][i];
                  return (
                    <div
                      key={i}
                    ...
                    >
                      ...
                      <div className="absolute top-0.5 left-1 font-[family-name:var(--font-geist-mono)] text-[7px] font-bold text-white/80">
                        #{i + 1}
                      </div>
                      {qty === 0 && (
                        <div className="absolute inset-0 bg-black/60 border border-dashed border-white/20 rounded-md" />
                      )}
                      {qty > 0 && (
                        <div className="absolute bottom-0.5 right-0.5 min-w-[12px] h-[12px] px-0.5 rounded bg-black/80 border border-white/20 font-[family-name:var(--font-geist-mono)] text-[7px] font-bold text-white flex items-center justify-center">
                          {qty}
                        </div>
                      )}
                    </div>
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[12px] text-gray-400">
                <span>
                  Completude <b className="text-white">68%</b>
                </span>
                <span className="text-gray-600">·</span>
                <span>
            ...
            <div>
              {features.map((f) => (
                <div key={f.title} className="py-5 border-b border-white/[0.06]">
                  <h3 className="text-[22px] sm:text-2xl font-black tracking-tight text-white mb-2">
                    {f.title}
                  </h3>
            ...
            {[
              {
                ...
                desc: "Grid com imagens reais de cada figurinha. Clique para marcar, controle quantidade por unidade.",
              },
              {
                title: "Preços flexíveis",
                desc: "Defina preços por tipo (normal, especial, brilhante) ou individualmente por figurinha.",
              },
              {
                title: "Vitrine online",
                desc: "Link exclusivo da sua loja. Clientes veem só o que está disponível e montam o pedido.",
              },
              {
                title: "WhatsApp integrado",
                desc: "Orçamento formatado vai direto pro WhatsApp do cliente com todos os detalhes.",
              },
              {
                title: "Gestão de pedidos",
                desc: "Workflow completo: orçamento, pagamento, envio. Tudo rastreado num só lugar.",
              },
              {
                title: "13 Copas + Copa 2026",
                desc: "De 1970 a 2022 catalogadas. Álbum da Copa 2026 será adicionado assim que lançar.",
              },
            ].map((f) => (
              <div
                key={f.title}
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-sm text-gray-500 mb-12">
            Comece grátis. Faça upgrade quando sua revenda crescer.
          </p>
            ...
            {[
              {
                ...
                price: "0",
                period: "grátis",
                features: ["100 figurinhas", "10 pedidos/mês", "1 álbum", "Vitrine básica"],
                highlight: false,
                cta: "Começar grátis",
              },
              {
              ...
              >
                ...
                <div className="flex items-baseline gap-1 mb-6">
                  ...
                  <span className="text-5xl font-black text-white font-[family-name:var(--font-geist-mono)] tracking-tighter">
                    {plan.price}
                  </span>
      ...
      <section className="relative px-4 sm:px-6 py-20 sm:py-28 border-t border-white/[0.06] overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <p className="text-[11px] text-gray-600 mt-5 font-[family-name:var(--font-geist-mono)]">
            7.122 figurinhas · 13 Copas · 1970–2026
          </p>
        </div>
      </section>
      ...
      <footer className="border-t border-white/[0.06] px-4 sm:px-6 py-8">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <span className="text-[11px] text-gray-600 italic">
            Feito para colecionadores, por colecionadores.
          </span>
        </div>
      </footer>
    </div>
