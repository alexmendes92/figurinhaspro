    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-5xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 min-w-0">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-accent-500 to-accent-600 flex items-center justify-center shadow-md shadow-accent-500/20 shrink-0">
                ...
                return (
                  <Link
                    ...
                    className={`group rounded-2xl border bg-zinc-900/60 overflow-hidden hover:border-zinc-600 transition-all hover:scale-[1.03] hover:shadow-xl hover:shadow-black/30 ${
                      album.isCustom ? "border-accent-500/20" : "border-zinc-800"
                    }`}
                  >
                    {/* Capa */}
                      ...
                      {coverSrc ? (
                        ...
                        <div className="flex items-center justify-center h-full">
                          <div className="text-center">
                            <div className="w-14 h-14 rounded-2xl bg-accent-500/10 border border-accent-500/20 flex items-center justify-center mx-auto mb-2">
                              <svg
                    ...
                    <div className="p-3 border-t border-zinc-800/50">
                      ...
                      <p className="text-xs text-accent-400 font-[family-name:var(--font-geist-mono)] font-semibold">
      ...
      <footer className="border-t border-zinc-800/50 px-4 py-5 text-center">
        <p className="text-[10px] text-zinc-600">
          Powered by <span className="text-accent-500 font-semibold">FigurinhasPro</span>
        </p>
      </footer>
    </div>
  );
